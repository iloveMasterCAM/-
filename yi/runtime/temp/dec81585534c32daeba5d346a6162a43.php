<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/data/home/qxu1146510236/htdocs/public/../application/index/view/index/index.html";i:1511711017;}*/ ?>
﻿<!DOCTYPE html>
...
<head>
    ...
    <link href="__CSS__/show/indexfrm.css" rel="stylesheet" />

    <link href="__CSS__/show/iconfont/iconfont.css" rel="stylesheet"/>

    <link href="__CSS__/show/uphead.css" rel="stylesheet"/>

    <link href="__CSS__/show/baidu.css" rel="stylesheet"/>

   <script src="__CSS__/show/iconfont/iconfont.js"></script>
...
<body>
    ...
    <ul id="nav" class="clear">
        ...
        <ul>
           ...
           <i></i>
            ...
            <li>yi-23 是一个网站收藏夹， 致力于帮助用户收藏网站，还加入了全球最大的中文搜索引擎——百度，建立友好、高效、一致的用户体验。
           ...
           <li class="aui-pull-right aui-padded-r-15 aui-margin-r-15 setindex"><a href="http://localhost/web/public/index/index/homepage.html">把yi-23设为主页</a></li>
           ...
           <li id="login" class="aui-pull-right login aui-hide"><a href="http://www.yi-23.com/public/index/index/login.html">登录</a> <span class="cursor">&nbsp;&nbsp;/&nbsp;&nbsp;</span><a href="http://www.yi-23.com/public/index/index/register.html" target="_blank">注册</a></li>

           <li class="aui-pull-right aui-padded-r-15  username cursor aui-hide"><img id="userhead" src="__IMG__/show/head.jpg" alt=""><a class="aui-margin-l-10" id="username"></a>
          ...
          <!--    <div class="content active">
                 ...
                 <div class="clear active">
                   ...
                   <p class="aui-pull-left box1">
                     ...
                     <img onclick="showbg(this)" class="img_Small" src="__IMG__/show/bg/Animal/1.jpg" alt="">
                     ...
                     <img onclick="showbg(this)" class="img_Small aui-pull-left mar-l mar-b" src="__IMG__/show/bg/Animal/1.jpg" alt="">

                      <img onclick="showbg(this)" class="img_large mar-l mar-t" src="__IMG__/show/bg/Animal/1.jpg" alt="">
                     ...
                     <img onclick="showbg(this)" class="img_Small mar-t" src="__IMG__/show/bg/Animal/1.jpg" alt="">
              ...
              <div class="content">
               ...
               <div class="content">
                 ...
                 <div class="clear active">
                     ...
                     <img onclick="showbg(this)" class="img_Small aui-pull-left mar-l mar-r mar-t" src="__IMG__/show/bg/Animal/1.jpg" alt="">
                     ...
                     <img onclick="showbg(this)" class="img_Small aui-pull-left mar-l mar-b" src="__IMG__/show/bg/Animal/1.jpg" alt="">
                      ...
                      <img onclick="showbg(this)" class="img_large  mar-t" src="__IMG__/show/bg/Animal/1.jpg" alt="">
   ...
   <form action="http://www.baidu.com/baidu" target="_blank" id="baidu">

        <table bgcolor="#FFFFFF"><tr><td>

        <p class="aui-text-center">  <a href="http://www.baidu.com/"><img src="__IMG__/show/baidu.png" alt="Baidu" align="bottom" border="0"></a></p>

        <input name=tn type=hidden value=baidu>

      

        <input type=text name=word size=30  url="true" id="Text" type="text">
...
<script src="__JS__/JScript2.js" type="text/javascript"></script>
...
<script src="__JS__/artTemplate.js"></script>

<!--<script src="__JS__/load.js"></script>-->
...
<script>
   ...
   $("#Collection").css({marginLeft:parseInt($(window).width()/2)-465})
    ...
    $(o).attr("src", "__IMG__/show/inter.png");
    ...
    if(islogin){
       ...
       post('index/Usermsg/usermsg','',function(r,d){
        ...
        $("#bg_skin").css({backgroundImage:'url('+usermsg.skin+')'});
       ...
       cache = new cache();
        ...
        cache.temp(function(r){
            ...
            $("#bg_skin").css({backgroundImage:'url('+r.skin+')'});
...
//        $("#headimg .img").css('backgroundImage','url('+srcs+')')
 ...
 if(document.body.style.overflow!="hidden"&&document.body.scroll!="no"&&
    ...
    function showimgfun(o){
            ...
            post('admin/html/showimg',{key:$(o).attr('key')},function(r,d){
                ...
                d.forEach(function(o,i){
                     ...
                     $("#"+$o.attr('key')+' img').eq(i).attr('src','__IMG__/'+o)
    ...
    function classname(){
            ...
            if(!color){
             ...
             $('#set input[name="color"]').eq(1).attr("checked",'checked');
              ...
              $("#Collection a,#Collection .head,#Collection .title").css({color:'#fff'})
    ...
    /*百度api */
        ...
        $("#Text").on('keyup mouseover',function(){
